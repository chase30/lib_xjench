...
<div class="container-fluid"><a class="brand" href="http://www.jeecg.org" target="_blank">基于智能车牌识别的违章信息管理系统<span class="slogan"></span></a>
...
<ul class="footer-links">
	...
	<li style="display: inline;">&nbsp;(推荐谷歌浏览器，获得更快响应速度)<a title="" href="#"></a></li>
</ul>
</div>
</footer>
